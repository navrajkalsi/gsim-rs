...
use crate::error::{RESET_UNDERLINE, UNDERLINE};
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        match self {
            ...
            Self::NonUsableChar(c) => write!(
                f,
                "Unexpected Character Detected:\nThe input contains the following ASCII character which is not supported: '{UNDERLINE}{}{RESET_UNDERLINE}'.",
                *c as char
            ),
            Self::NoSuffix(prefix) => write!(
                f,
                "Invalid Format:\nNo numeric value found after the following prefix character: {UNDERLINE}{}{RESET_UNDERLINE}, which is invalid G-Code.",
                *prefix as char
            ),
            Self::ParseSuffix(prefix) => write!(
                f,
                "Numeric Parsing Error:\nA numeric value failed to parse that is prefixed by {UNDERLINE}{}{RESET_UNDERLINE}.",
                *prefix as char
            ),
        }
    }

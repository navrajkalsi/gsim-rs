...
impl Block {
    ...
    fn tokenize(line: &str) -> Result<Self, LexerError> {
        let mut tokens = Vec::with_capacity(5); // start with 5 tokens in a block
...
impl Lexer {
    ...
    /// **Optionally** returns the [`Line`](crate::source::Line) at `index` as a string slice from the [`Source`].
...
impl Iterator for Lexer {
    ...
    /// **Optionally** tokenizes the next [`Line`](crate::source::Line) from stored [`Source`].
    ///
